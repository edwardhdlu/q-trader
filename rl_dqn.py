...
plot_barchart(profit_vs_episode	,  "episode vs profit",  "total profit", "episode", 'green')

print(f'see plot of trades_vs_episode = {trades_vs_episode}')
plot_barchart(trades_vs_episode	,  "episode vs trades",  "total trades", "episode", 'blue')

print(f'see plot of epsilon_vs_episode = {trades_vs_episode}')
plot_barchart(epsilon_vs_episode	,  "episode vs epsilon ",  "epsilon(probability of random action)", "episode", 'red')
